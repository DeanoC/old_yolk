#pragma once
#ifndef _YOLK_CORE_KEYBOARD_NULL_H_
#define _YOLK_CORE_KEYBOARD_NULL_H_ 1

namespace Core {

// each key has a label KT_x (i.e. A = KT_A
enum KeyTable {
#define NK_KEY_MAP(c , d) KT_##c,
#define KT_MAP(c, d) KT_##c,
#define KT_F_MAP(c) KT_##c,
#define KT_KP_MAP(c, d) KT_##c,
