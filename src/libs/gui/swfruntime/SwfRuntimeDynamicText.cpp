...
namespace Swf {
	SwfRuntimeDynamicText::SwfRuntimeDynamicText ( SwfDynamicText* _text) {
		dynText = _text;
	...
	void SwfRuntimeDynamicText::align_line(SwfTextAlign _align, SwfTextRecord* _rec, float x) {
	...
	void	SwfRuntimeDynamicText::format_text(SwfPlayer* _player, SwfFrameItem* _parent) {
		SwfRuntimeFont* font = _player->getFont(dynText->fontId);
   ...
   void SwfRuntimeDynamicText::Display(	SwfPlayer* _player,
       ...
       SwfRuntimeText::Display(_player, _parent, _concatMatrix, _colourTransform, _depth, _clipLayer, _morph);
   }
